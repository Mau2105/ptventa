...
Este documento describe las funcionalidades disponibles en cada módulo de la plataforma SICEFA. Sirve como referencia rápida para comprender qué resuelve cada paquete, qué rutas expone y qué dependencias internas utiliza.
