                    ...
                    <div class="row">
                            ...
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="500" style="height: 200px;">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://laravel.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/php.webp') }}" alt="PHP-logo"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://www.php.net/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="700"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/datatables_logo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://datatables.net/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/adminLTE3.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://adminlte.io/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="500"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/fontawesome.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://fontawesome.com/icons">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/googlefonts.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://fonts.google.com/specimen/Quicksand?preview.text=Infinity%20Mellow&preview.text_type=custom&selection.family=Yellowtail&sidebar.open=true&query=quicksa">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="700"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/pixabay.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://pixabay.com/es/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/sweetalert2.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://sweetalert2.github.io/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="500"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/javascript_logo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://developer.mozilla.org/es/docs/Web/JavaScript">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/jquery.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://jquery.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="700"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/css3_logo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://developer.mozilla.org/es/docs/Web/CSS">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/bootstrap_logo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://getbootstrap.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/livewire.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://laravel-livewire.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="700"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/laravelcollective.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://laravelcollective.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="500"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/xampp.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://www.apachefriends.org/es/index.html">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/sqlyog.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://webyog.com/product/sqlyog/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/github_logotipo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://github.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800"
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/cleavejs_logo.webp') }}"
                                    ...
                                    <a class="btn btn-success btn-block w-100"
                                        href="https://nosir.github.io/cleave.js/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
